...
if(isset($_POST["edit_title"]) && isset($_POST["edit_info"]) && isset($_POST["edit_deadline"]) && isset($_SESSION["The_ID"])){
    ...
    $sql = "UPDATE job SET Topic='$edit_title', Info='$edit_info', End='$edit_deadline' WHERE The_ID='$edit_the_id'";
    $conn -> query($sql);
