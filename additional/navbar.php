...
<div id="nav" onclick="nav_hidenot()">
	...
	if($is_su == 1){
		$navbar = $navbar.'<div id="nav_link" onclick=\'nav_classic_link("stats.php")\'><span style="color:rebeccapurple;">STATYSTYKI</span></div>';
	}

	$navbar = $navbar.'<div id="nav_link" onclick=\'nav_classic_link("create-account.php")\'><span style="color:#00ff00;">DODAJ NOWĄ OSOBĘ</span></div>
