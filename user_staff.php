...
<html lang="pl">
    ...
    <div class="content">
        ...
        <div id="div_panel">
            <?php
                if($_SESSION["dzial"]=="kadr")
                    echo '<div onclick="new_staffjob()" id="new_job">DODAJ ZADANIE KADROWE</div>';
            ?>
        ...
        <div id="div_aktualne">
            ...
            <?php
                ...
                if(isset($conn))
                {
					...
					if($sort=="Deadline")
						$sql="SELECT * FROM job WHERE ForWho=$id AND Type='sta' ORDER BY End ASC";
					
					else
						$sql="SELECT * FROM job WHERE ForWho=$id AND Type='sta' ORDER BY Length DESC, End ASC";
        ...
        <?php
            ...
            */
            ...
            $sql = "SELECT * FROM job WHERE WhoAdd='$my_id_nadane' AND ForWho!='$my_id_nadane' AND Type='sta' ORDER BY End ASC";
		
			else
				$sql = "SELECT * FROM job WHERE WhoAdd='$my_id_nadane' AND ForWho!='$my_id_nadane' AND Type='sta' ORDER BY Length DESC, End ASC";
            ...
            while($res = mysqli_fetch_array($que)){
                ...
                if($exist==1){
					...
					if($already==0){
						...
						echo '<div><h2>ZADANIA KADROWE - NADANE</h2></div>';
						$already=1;
                    }
    ...
    <script>
        ...
        function new_staffjob(){
            ...
            if(document.getElementById("okno_background").style.display=="none"){
                ...
                $.get("additional/processor.php", {the_staffjob: the_staffjob}, function(data){
                    $('#okno_job').html(data);
                });
            }
            else if(okno==0){
